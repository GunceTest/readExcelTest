...
public class TestBase {
    ...
    public void beforeMethod(Method method) throws Exception {
    	...
    	////////////////////*********testNG ile çalıştırılacaksa(DEBUG) parametreler buradan tanımlanmalı******
        System.setProperty("browser", "chrome");
        System.setProperty("env", "testgunce");
    ...
    public void afterClass() {
       ...
       driver.quit(); //  bunun aciklama satırını açmazsan eğer ram şişer bigBANGGG!!!
    ...
    public void afterSuite() throws Exception {
        extent.flush();
        //provider'da yazılacak method buradan çağırılacak.
        Provider provider = new Provider();
        String env = System.getProperty("env");
        //provider.ExecuteCommand("exec SetYtoN", env, "db");
    }
